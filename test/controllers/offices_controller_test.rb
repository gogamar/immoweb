...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference("Office.count") do
      post offices_url, params: { office: { address: @office.address, name: @office.name, phone_number: @office.phone_number } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { address: @office.address, name: @office.name, phone_number: @office.phone_number } }
