...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { listing_id: @feature.listing_id, name: @feature.name, value: @feature.value } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { listing_id: @feature.listing_id, name: @feature.name, value: @feature.value } }
